...
export const uuidHandler = (value, options = {}) => {
    if (typeof value !== 'string' || !value.trim()) {
        throw new TypeError(`[normalize:uuid] Expected non-empty string. Received: ${typeof value}`);
    }
    ...
    if (version !== null) {
        ...
        if (!regex) {
            throw new TypeError(`[normalize:uuid] Unsupported version: ${version}. Supported: 1, 3, 4, 5, 7.`);
        }
...
//# sourceMappingURL=uuidHandler.js.map